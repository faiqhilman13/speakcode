...
/*
 * Hook Scene: Big, bold question that stops the scroll
 * Layout: Full screen impact, minimal padding
 */
...
export const HookScene: React.FC = () => {
  ...
  const accentWidth = showAccent
    ? interpolate(frame - 55, [0, 12], [0, 500], { extrapolateRight: "clamp" })
    : 0;
  ...
  return (
    <AbsoluteFill style={{ background: "#FDF6E3" }}>
      ...
      {/* Large decorative quotation mark - bigger */}
      <div
        style={{
          position: "absolute",
          top: 100,
      ...
      <div style={{
        ...
        <div
          style={{
            ...
            opacity: showLine1 ? 1 : 0,
            transform: `translateX(${(1 - line1X) * -50}px)`,
          }}
        >
          What if you could
        </div>
        ...
        <div
          style={{
            ...
            transform: `translateX(${(1 - line2X) * -50}px)`,
          }}
        >
          build software
        </div>
        ...
        <div
          style={{
            ...
            transform: `translateX(${(1 - line3X) * -50}px)`,
          }}
        >
      ...
      >
        <div style={{ width: 50, height: 3, background: "#FF5E5B" }} />
        <div style={{
          fontFamily: "'SF Mono', monospace",
          fontSize: 14,
